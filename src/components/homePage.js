  ...
  return(
    <div className="w-full h-full flex flex-col">
      ...
      <div className="h-full w-full flex items-center">
        <div className=" fixed h-[200%] w-full left-[-83%] top-[-50%] bg-[#4db5ff]" id="home-decor"></div>
        <div className=" flex h-full w-full py-5 items-center justify-between">
          ...
          <div className="flex flex-col items-center justify-center w-full ms-10 mt-10 text-xl text-[#f5f6f7]">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className="fill-[#4db5ff] h-[80px] mt-5" viewBox="0 0 320 512"><path d="M137.4 374.6c12.5 12.5 32.8 12.5 45.3 0l128-128c9.2-9.2 11.9-22.9 6.9-34.9s-16.6-19.8-29.6-19.8L32 192c-12.9 0-24.6 7.8-29.6 19.8s-2.2 25.7 6.9 34.9l128 128z"/></svg>
          </div>
        </div>
      </div>
    </div>
