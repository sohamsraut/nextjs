...
export default function homePageComponent() {
  return (
      <section className="min-h-full w-full flex items-center relative" id="home">
        ...
        <div className=" flex flex-col md:flex-row min-h-full w-full py-5 items-center md:justify-between justify-center">
          <img src="./placeholder.jpg" className="lg:h-4/5 md:h-3/5 sm:h-[300px] sm:w-[300px] h-[250px] w-[250px] mt-20 rounded-full md:rounded-3xl z-[111] left-10 lg:ms-20 md:ms-10"/>
          <div className="flex flex-col items-center justify-center w-full md:ms-10 mt-10 pt-20 text-xl z-[111] text-[#f5f6f7] bg-[#111]/[0.9]">
            <p className="text-lg">Hello there, I'm</p>
            <p className="heading lg:text-7xl sm:text-6xl text-5xl mt-3 font-bold">Soham Raut</p>
            <p className="mt-5 mx-20 tmd:ext-base lg:text-xl text-sm text-center">
